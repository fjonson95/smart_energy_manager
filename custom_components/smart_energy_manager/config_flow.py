...
def _solar_schema(d: dict) -> vol.Schema:
    return vol.Schema({
        ...
        vol.Optional(CONF_SOLAR_CURTAILMENT_ENTITY, default=_d(d, CONF_SOLAR_CURTAILMENT_ENTITY, "")): _opt_entity_selector(),
        vol.Optional(CONF_SOLAR_INVERTER_RATED_KW, default=_d(d, CONF_SOLAR_INVERTER_RATED_KW, DEFAULT_SOLAR_INVERTER_RATED_KW)): vol.Coerce(float),
    })
...
def _heat_pump_schema(d: dict) -> vol.Schema:
    return vol.Schema({
        ...
        vol.Optional(CONF_HOT_WATER_TEMP_ENTITY, default=_d(d, CONF_HOT_WATER_TEMP_ENTITY, "")): _opt_entity_selector(),
        vol.Optional(CONF_EXTRA_HOT_WATER_MAX_TEMP, default=_d(d, CONF_EXTRA_HOT_WATER_MAX_TEMP, DEFAULT_EXTRA_HOT_WATER_MAX_TEMP)): vol.Coerce(float),
        vol.Optional(CONF_EXTRA_HOT_WATER_MIN_TEMP, default=_d(d, CONF_EXTRA_HOT_WATER_MIN_TEMP, DEFAULT_EXTRA_HOT_WATER_MIN_TEMP)): vol.Coerce(float),
        vol.Optional(CONF_EXTRA_HOT_WATER_MIN_RUNTIME_MINUTES, default=_d(d, CONF_EXTRA_HOT_WATER_MIN_RUNTIME_MINUTES, DEFAULT_EXTRA_HOT_WATER_MIN_RUNTIME_MINUTES)): vol.Coerce(int),
        vol.Optional(CONF_AUXHEATER_STATUS_ENTITY, default=_d(d, CONF_AUXHEATER_STATUS_ENTITY, "")): _opt_entity_selector(),
        vol.Optional(CONF_AUXHEATER_LEVEL_ENTITY, default=_d(d, CONF_AUXHEATER_LEVEL_ENTITY, "")): _opt_entity_selector(),
        vol.Optional(CONF_AUXHEATER_RATED_KW, default=_d(d, CONF_AUXHEATER_RATED_KW, DEFAULT_AUXHEATER_RATED_KW)): vol.Coerce(float),
        vol.Optional(CONF_BOILER_PVMAXCOMP_ENTITY, default=_d(d, CONF_BOILER_PVMAXCOMP_ENTITY, "")): _opt_entity_selector(),
        vol.Optional(CONF_BOILER_PVMAXCOMP_MAX_KW, default=_d(d, CONF_BOILER_PVMAXCOMP_MAX_KW, DEFAULT_BOILER_PVMAXCOMP_MAX_KW)): vol.Coerce(float),
    })
...
def _legionella_schema(d: dict) -> vol.Schema:
    return vol.Schema({
        ...
        vol.Optional(CONF_LEGIONELLA_SWITCH, default=_d(d, CONF_LEGIONELLA_SWITCH, "")): _opt_entity_selector(),
        vol.Optional(CONF_LEGIONELLA_TARGET_TEMP, default=_d(d, CONF_LEGIONELLA_TARGET_TEMP, DEFAULT_LEGIONELLA_TARGET_TEMP)): vol.Coerce(float),
        vol.Optional(CONF_LEGIONELLA_MIN_INTERVAL_DAYS, default=_d(d, CONF_LEGIONELLA_MIN_INTERVAL_DAYS, DEFAULT_LEGIONELLA_MIN_INTERVAL_DAYS)): vol.Coerce(int),
        vol.Optional(CONF_LEGIONELLA_MAX_INTERVAL_DAYS, default=_d(d, CONF_LEGIONELLA_MAX_INTERVAL_DAYS, DEFAULT_LEGIONELLA_MAX_INTERVAL_DAYS)): vol.Coerce(int),
